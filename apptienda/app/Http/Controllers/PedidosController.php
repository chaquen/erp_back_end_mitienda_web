                    ...
                    foreach ($arr as $key => $value) {
                        ...
                        //unidades ingresadas por unidades por blister
                            $pro=DB::table("productos")
                                ...
                                ->select("productos.id as id_producto","detalle_inventarios.id as id_inventario","productos.unidades_por_caja","sedes.id")
                                ->where([
                                            [
                                ...
                                if(count($pro)>0){
                                    ...
                                    ->increment("cantidad_existencias_unidades",($value["cantidad_solicitada"]*$pro[0]->unidades_por_caja);    
                                    ...
                                    DB::table("detalle_inventarios")
                                      ->where("id","=",$pro[0]->id_inventario)
                                      ->update([
                                            "cantidad_existencias"=>floor(($di[0]->cantidad_existencias_unidades/$di[0]->unidades_por_caja),"estado_inventario"=>"activo"]);
