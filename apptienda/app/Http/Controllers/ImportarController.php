                                                                   ...
                                                                   if($value["codigo_venta_menudeo_o_unidad"]==NULL){
                                                                     ...
                                                                     if($registar && $value["codigo_coopidrogas"]!=NULL){
                                                                          ...
                                                                          $arr_sin_coincidencias_en_bd[$i]=[
                                                                             ...
                                                                             "precio_compra_unidad"=>$value["precio_costo_unidad"],
                                                                             "precio_compra_impuesto"=>$value["precio_costo_impuesto"],
                                                                             ,
                                                                             "precio_compra_unidad_impuesto"=>$value["precio_costo_unidad_impuesto"],
                                                                             "porcentaje_ganancia"=>$value["porcentaje_ganancia"],
                                                                             "porcentaje_ganancia_unidad"=>$value["porcentaje_ganancia_unidad"],
                                                                             "precio_venta"=>$value["precio_venta"],
                                                                             "precio_mayoreo"=>$value["precio_venta_unidad"],
