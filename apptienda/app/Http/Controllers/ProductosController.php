...
class ProductosController extends Controller
{
      ...
      public function store(Request $request)
    {
        ...
        if($pro["respuesta"]==false){
            ...
            $arr=$prod->insertar(array(
                ...
                "precio_compra_unidad_impuesto"=>$datos->datos->precio_compra_unidad,
    ...
    public function update(Request $request, $id)
    {
        ...
        if($datos->datos->fk_id_sede=="0"){
            ...
            $rr=$prod->editar(array(
                ...
                "precio_compra_unidad_impuesto"=>$datos->datos->precio_compra_impuesto,
                "precio_venta"=>$datos->datos->precio_venta,
            ...
            foreach ($pr_dt as $key => $value) {
                    ...
                    $dt->editar([
                                ...
                                "cantidad_existencias"=>floor($value->cantidad_existencias_unidades/$datos->datos->unidades_por_caja),
                                "porcentaje_ganancia_sede"=>$datos->datos->porcentaje_ganancia,
                    ...
                    DB::table("detalle_inventarios")
                            ...
                            ->update(["precio_venta_sede"=>$datos->datos->precio_venta,
                                      ...
                                      "precio_mayoreo_sede"=>$datos->datos->precio_mayoreo,
                                       ...
                                       "cantidad_existencias"=>floor($resp[0]->cantidad_existencias_unidades/$datos->datos->unidades_por_caja),                                
                                        "updated_at"=>$datos->hora_cliente]);
                    ...
                    $actualizar=true;
                     ...
                     switch ($campo){
                         case "precio_compra":
                             ...
                             $precio_unidad=($valor/$pp[0]->unidades_por_caja);
                         ...
                         case "unidades_por_caja":
                            ...
                            $actualizar=true;
                            $actualizar2=false;
                             //actulizar las cantidades de las cajas y los 
                              $s=DB::table("sedes")
                                    ->get();
                            foreach ($s as $key => $value) {
                                ...
                                $d=DB::table("detalle_inventarios")
                                    ...
                                    ->get();
                                if(count($d)>0){
                                    if((int)$d[0]->unidades_por_caja!=0 && $valor != 0){
                                     DB::table("productos")
                                        ->where("productos.id","=",$id_producto)        
                                        ->update(["precio_compra_unidad"=>(int)$d[0]->precio_compra/(int)$valor
                                                 ]);
                                    }else{
                                        return response()->json(["respuesta"=>false,"mensaje"=>"Unidades  estan en cero"]);
                                    }    
                     ...
                     switch ($campo){
                         ...
                         case "unidades_por_caja":
                            ...
                            if($d[0]->unidades_por_caja!= 0){
                                DB::table("productos")
                                ->where("productos.id","=",$id_producto)        
                                ->update(["precio_compra_unidad"=>(int)((int)$d[0]->precio_compra/(int)$valor)]);
                            ...
                            if($d[0]->unidades_por_caja!= 0){
                                DB::table("detalle_inventarios")
                                ->where("fk_id_producto","=",$id_producto)
                                ->update(["cantidad_existencias"=>floor(
                                    (int)$d[0]->cantidad_existencias_unidades/(int)$valor)]);    
                            }else{
                                return response()->json(["respuesta"=>false,"mensaje"=>"Unidades de  estan en cero"]);
                            }
                        ...
                        if($d[0]->unidades_por_caja != 0){
                            ...
                            ->where("id","=",$id_producto)
                             ->update([ 
                                        ...
                                        "cantidad_existencias"=>floor($valor/(int)$d[0]->unidades_por_caja),
                            ...
                            return response()->json(["respuesta"=>false,"mensaje"=>"Las unidades de caja  deben ser mayor a cero"]);
                        }
    ...
    public function crear_productos_inventario(Request $request){
        ...
        if($pro["respuesta"]==false){
            ...
            if($datos->datos->tipo_venta_producto=="Unidad"){
               $unidades =$datos->datos->cantidad_existencias;
            }else{
                $unidades=$datos->datos->cantidad_existencias*$datos->datos->unidades_por_caja;
            }
