    ...
    public function store(Request $request)
    {
        ...
        //var_dump($sel);    
         ...
         $hay=DB::table("detalle_inventarios")
            ...
            ->select("detalle_inventarios.cantidad_existencias_unidades","productos.inventario","productos.unidades_por_caja")     
            ->get();  
            //var_dump($hay);
                            ...
                            $dt2=DB::table("detalle_inventarios")
                             ...
                             DB::table("detalle_inventarios")
                                                ...
                                                ->update([
                                                            ...
                                                            "cantidad_existencias"=>floor($dt2[0]->cantidad_existencias_unidades/$dt[0]->unidades_por_caja)
